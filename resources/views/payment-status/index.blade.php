                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <a href="{{route('payment-status.create')}}" class=" btn btn-primary btn-gradient round  ">Add Status</a>
                                </div>
                                    ...
                                    <table class="datatables-ajax table table-responsive datatable_data">
                                        ...
                                        <script>
                                            function ChangeStatusActive (id){
                                                $.ajax({
                                                    url: "{{ route('payment-status.change_status') }}",
                                                    type: 'POST',
                                                    dataType: 'json',
                                                    data: {
                                            ...
                                            function ChangeISDefaultTo(id,name){
                                                ...
                                                if (result) {
                                                    window.location.href = "{{ route('payment_status.change_default_to', ':id') }}".replace(':id', id);
                                                } else {
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="{{route('payment-status.edit',$val->id)}}">
                                                    ...
                                                    <div class="modal fade modal-danger text-start" id="danger_ke{{ $val->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    @if ($val->is_default != 1)
                                                                    <form action="{{route('payment-status.destroy',$val->id)}}" method="POST">
                                                                        @endif 
                                                                        @csrf
                                                                        @method('delete')
