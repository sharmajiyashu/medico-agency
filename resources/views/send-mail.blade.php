...
<head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1.0$testMailData['user']-scalable=0,minimal-ui">
                    ...
                    <div class="row" style="padding-top: 2%;">
                        <div class="col-md-12">
                            ...
                            <div class="centered-table">
                                <table class="datatables-ajax table table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <th class="py-1">Mobile: {{ $testMailData['user']->mobile }}</th>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="centered-table">
                                <table class="datatables-ajax table table-responsive">
                                    <tr>
                                        <th class="py-1">{{ $testMailData['user']->business_name }}</th>
                                        
                                        <th class="py-1" rowspan="2" >DL No.: {{ $testMailData['user']->dl }}</th>
                                        <th class="py-1" rowspan="2" >Entry No : {{ $testMailData['order']->id }} <br>
                                            Date : {{ date('d-m-y H:i:s',strtotime($testMailData['order']->created_at)) }}
                                            </th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="centered-table">
                                <table class="datatables-ajax table table-responsive">
                                    ...
                                    <?php $i=1; ?>
                                    @foreach ($testMailData['order_item'] as $item)
                                        <tr>
                                            <th class="py-1">{{ $i }}</th>
                                            <th class="py-1">{{ $item->product_name }}</th>
                                            <th class="py-1">{{ $item->quantity }}</th>
                                        </tr>
                                        <?php $i++; ?>
                                    @endforeach
