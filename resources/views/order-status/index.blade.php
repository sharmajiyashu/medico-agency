            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Order Status</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('master.order-status.index') }}">Order Status</a>
                                    </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <a href="{{route('master.order-status.create')}}" class=" btn btn-primary btn-gradient round  ">Add Status</a>
                                </div>
                                    ...
                                    <table class="datatables-ajax table table-responsive datatable_data">
                                        ...
                                        <script>
                                            function ChangeStatusActive (id){
                                                $.ajax({
                                                    url: "{{ route('master.order-status.change_status') }}",
                                                    type: 'POST',
                                                    dataType: 'json',
                                                    data: {
                                            ...
                                            function ChangeISDefaultTo(id,name){
                                                ...
                                                if (result) {
                                                    window.location.href = "{{ route('master.order-status.change_default_to', ':id') }}".replace(':id', id);
                                                } else {
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="{{route('master.order-status.edit',$val->id)}}">
                                                    ...
                                                    <div class="modal fade modal-danger text-start" id="danger_ke{{ $val->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    @if ($val->is_default != 1)
                                                                    <form action="{{route('master.order-status.destroy',$val->id)}}" method="POST">
                                                                        @endif 
                                                                        @csrf
                                                                        @method('delete')
